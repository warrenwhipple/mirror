---
name: mirror-check
description: Check or create a human-owned MIRROR.md or MIRROR-*.md for drift/misunderstandings. Use when user says "check mirror", "check {particular} mirror", "mirror check", "new mirror", etc.
---
